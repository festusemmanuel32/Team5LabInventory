...
/**
    *@method boolean search_lab($lab_name,$lab_id,$lab_location,$equip_id) allows users to search for labs
...
**/
	...
	{
		$str_query="select * from labs where lab_name= '$Lab_name',lab_id = '$lab_id', lab_location ='$lab_location' 
			$equip_id = equip_id'";
...
/** 
	*@method boolean add_lab($lab_name, $lab_id,$lab_location,$capcaity,$equip_id,$supplierID)allows 
	* the Administrator to add new labs given their names, ids, location and capacity
	*@param String $lab_name// The name of a lab
	*@param integer $lab_id// The assigned id of a lab
...
**/
	...
	{
		$str_query="insert into labs set lab_name='$lab_name',lab_id='$lab_id',lab_location ='$lab_location',
            capcaity='$capcaity','equip_id = $equip_id', '$supplierID =supplier_id' ";

        return $this->query($str_query);
	}

/** 
	*@method boolean delete_lab($lab_id)allows the Administrator to remove labs given their id
...
/** 
	*@method boolean edit_lab($lab_name, $lab_id,$lab_location,$capcaity)allows the Administrator to 
	* modify labs given their names, id, physical location and capacity
	*@param String $lab_name// The name of a lab
	*@param integer $lab_id// The assigned id of a lab
	*@param varchar $lab_location// The assigned location of a lab
	*@param integer $capacity// The equipment capcity of a lab
...
**/
	...
	{
		$str_query="update labs set lab_name='$lab_name',lab_id='$lab_id',lab_location ='$lab_location',capcaity='$capcaity'";	
